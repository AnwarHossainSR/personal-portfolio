...
export const roles: Role[] = [
	{
		...
		impact: [
			"Work on the React and Highcharts authoring interface — charts, maps and tables — and on the distributed services behind it that store, render, publish and export what it produces, including image and video export.",
			"Moved environment provisioning to Terraform, so environments are reproducible from code rather than assembled by hand.",
			"Built the CI/CD pipelines on GitHub Actions and the Serverless Framework that the team releases the monorepo through, and added AI features and an MCP server over the product API.",
		],
		stack: [
			"React",
			"Node.js",
