import { ArrowRight, Download, ExternalLink, Github, Linkedin, Mail, ChevronDown } from 'lucide-react';
    ...
    <>
          ...
          <div className="space-y-12 slide-in-up hero-glow">
            <div className="space-y-6">
              <div className="inline-flex items-center px-4 py-2 rounded-full bg-primary/10 border border-primary/20 backdrop-blur-sm mb-4">
                <span className="text-sm text-primary font-medium">🚀 Senior Software Engineer</span>
              </div>
              ...
              <h2 className="text-2xl sm:text-4xl lg:text-5xl font-medium text-muted-foreground/80 leading-tight">
              ...
              <div className="flex flex-wrap justify-center gap-3 text-lg">
                <span className="px-4 py-2 bg-card/50 backdrop-blur-sm rounded-full border border-card-border text-foreground/80">
            ...
            <p className="text-xl sm:text-2xl text-muted-foreground/90 max-w-4xl mx-auto leading-relaxed font-light">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
            ...
            <p className="text-xl text-muted-foreground/80 max-w-3xl mx-auto leading-relaxed">
              Technologies and methodologies I leverage to architect and deliver enterprise-grade solutions
            </p>
          </div>
          
          <div className="flex flex-wrap justify-center gap-6 fade-in-stagger">
            {topSkills.map((skill, index) => (
              <div
                key={skill}
                className="group premium-card interactive-card px-8 py-4 cursor-default"
                style={{ animationDelay: `${index * 0.1}s` }}
              >
                <span className="text-base font-semibold text-foreground/90 group-hover:text-primary transition-colors">
                  {skill}
                </span>
      ...
      <section className="py-32 relative">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
            ...
            <p className="text-xl text-muted-foreground/80 max-w-3xl mx-auto leading-relaxed">
              Production-ready solutions showcasing technical expertise across full-stack development and cloud architecture
            </p>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 fade-in-stagger">
            {featuredProjects.map((project, index) => (
              <div key={project.id} className="group premium-card interactive-card p-8 relative overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-sm text-muted-foreground/70">{project.year}</span>
                    </div>
      ...
      <section className="py-32 relative">
        ...
        <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="premium-card p-16 hero-glow">
            <h2 className="text-4xl sm:text-5xl font-bold mb-8">
              Ready to Build Something <span className="gradient-text">Extraordinary</span>?
            </h2>
            <p className="text-xl text-muted-foreground/90 mb-12 max-w-3xl mx-auto leading-relaxed">
              I'm passionate about tackling complex technical challenges and building scalable systems that drive business growth. 
