					...
					<div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
						<div className="space-y-12 slide-in-up hero-glow">
							<div className="space-y-6">
								<div className="inline-flex items-center gap-2.5 px-4 py-2 rounded-full bg-success/10 border border-success/20 backdrop-blur-sm mb-4">
				...
				<section className="py-16 sm:py-24 lg:py-32 relative">
					...
					<div className="relative max-w-7xl mx-auto px-3 sm:px-6 lg:px-8">
						<SectionHeading
							...
							subtitle="Technologies and methodologies I leverage to architect and deliver enterprise-grade solutions"
						/>
				...
				<section className="py-16 sm:py-24 lg:py-32 relative">
					...
					<div className="relative max-w-7xl mx-auto px-3 sm:px-6 lg:px-8">
						<SectionHeading
							...
							subtitle="Production-ready solutions showcasing technical expertise across full-stack development and cloud architecture"
						/>
