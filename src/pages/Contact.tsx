				...
				<div className="section-shell">
					<div className="mx-auto max-w-3xl text-center slide-in-up">
						...
						<h1 className="mt-3 text-4xl font-black sm:text-6xl">
							Let us discuss the engineering work
						</h1>
					...
					<div className="mt-12 grid gap-8 lg:grid-cols-[0.88fr_1.12fr]">
						<div className="space-y-4">
							...
							<div className="premium-card p-5">
								...
								<p className="mt-2 text-sm leading-6 text-muted-foreground">
									Open the PDF resume for the complete experience, skills, and
									contact summary.
								</p>
								<Button
									className="mt-4 w-full bg-gradient-primary font-bold text-primary-foreground"
									asChild
								>
									<a
						...
						<div className="premium-card p-6 sm:p-8">
							...
							<p className="mt-2 text-sm text-muted-foreground">
								This opens your email app with the message prepared. No backend
								form service is required.
							</p>
							<form
							...
							>
								<div className="grid gap-4 md:grid-cols-2">
									<div>
										...
										<Input
											...
											{...register("name")}
											className="border-card-border bg-background/70"
										/>
										{errors.name && (
								...
								<Button
									type="submit"
									size="lg"
									className="w-full bg-gradient-primary font-bold text-primary-foreground"
									disabled={!isValid}
								>
