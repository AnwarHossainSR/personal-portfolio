				...
				<section className="py-20 bg-card/30">
					<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
						<SectionHeading
							...
							subtitle="Core competencies that drive successful project delivery and team excellence"
						/>
						...
						<div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
							...
							<div className="premium-card p-6 sm:p-8 text-center group hover:scale-105 transition-all duration-300">
								...
								<p className="text-sm sm:text-base text-muted-foreground">
									Leading development teams, mentoring engineers, and
									establishing best practices for code quality.
								</p>
							</div>
				...
				<section className="py-20">
					<div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
						<SectionHeading
							...
							subtitle="Key milestones in my software engineering career"
						/>
