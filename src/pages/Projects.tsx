      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16 slide-in-up">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            A showcase of innovative solutions, scalable architectures, and impactful applications I've built
          </p>
        </div>

        {/* Filters and Search */}
        <div className="mb-12 slide-in-up" style={{ animationDelay: '200ms' }}>
              ...
              <div className="p-6 space-y-4">
                ...
                <div className="flex flex-wrap gap-1">
                  {project.technologies.map((tech) => (
                    <span
                      key={tech}
                      className="text-xs bg-muted/50 text-muted-foreground px-2 py-1 rounded hover:bg-primary/10 hover:text-primary transition-colors"
                    >
                      {tech}
                    </span>
                  ))}
        ...
        <div className="text-center mt-20 premium-card p-8">
          ...
          <p className="text-muted-foreground mb-6 max-w-2xl mx-auto">
            These are just highlights. Visit my GitHub profile to explore my complete portfolio of projects and contributions.
          </p>
          <Button size="lg" className="bg-gradient-primary" asChild>
            <a href="https://github.com/anwar" target="_blank" rel="noopener noreferrer">
